...
namespace API.Controllers
{
    ...
    public class ProductsController : BaseApiController
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IReadOnlyList<ProductToReturnDto>>> GetProducts([FromQuery]ProductQueryParams productParams)
        {
            

            var data = await _repository.GetProductsWithIncludes(productParams);
